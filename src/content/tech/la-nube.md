...
date: 2020-05-18
description: "Qué es «la nube» de verdad, explicado con una nevera y una heladería — sin tecnicismos ni conocimientos previos."
lang: es
tags: ["cloud", "basics", "datacenter"]
translationKey: "the-cloud"
takeaways:
  - "Un centro de datos es una bodega llena de computadores potentes, refrigerada igual que una nevera conserva los alimentos."
  - "Los servidores son los compartimentos de esa nevera, y las aplicaciones son los alimentos guardados en ellos."
  - "«La nube» es lo que ocurre cuando una empresa tiene tantos centros de datos que puede alquilar espacio en ellos a todos los demás."
  - "Los mayores proveedores de la nube son Amazon Web Services, Microsoft Azure, Google Cloud Platform, Alibaba Cloud, IBM Cloud y Oracle Cloud."
  - "Cada archivo que subes a Google Drive o iCloud está en un computador físico, en un edificio, en algún lugar del mundo."
---
...
![Una nevera con compartimentos etiquetados, comparados con un centro de datos, servidores y aplicaciones](../../assets/images/cloud/fridge-sm.png)
...
![Recipientes de helado en el mostrador de una heladería](../../assets/images/cloud/ice-cream.jpg)
...
![Filas de racks de servidores dentro de un centro de datos](../../assets/images/cloud/datacenter.jpg)
